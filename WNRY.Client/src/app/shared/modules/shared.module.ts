...
import { HeaderImageComponent } from '../header-image-component/header-image.component';

@NgModule({
	imports:      [CommonModule],
	declarations: [myFocus, SpinnerComponent, HeaderImageComponent],
	exports:      [myFocus, SpinnerComponent, HeaderImageComponent],
	providers:    []
})
